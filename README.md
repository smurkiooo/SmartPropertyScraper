...
На следующем шаге (ДЗ №2) планируется замена на S3-совместимое хранилище.

## Что дальше (ДЗ №2)

- Скачивание фотографий по `image_urls` в `data/images/<offer_id>/`
- Замена локального DVC-remote на удалённый (S3 / Yandex Object Storage)
- Расширение признаков (тип санузла, ремонт, парковка)
